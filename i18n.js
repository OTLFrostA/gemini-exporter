...
(function(global) {
    const LOCALES = {
        zh: {
            ...
            selectUpdated: "只选已更新",
            btnIncrementalScan: "重新 sync (增量)",
            btnIncrementalScanTip: "快速增量拉取，遇到连续20条未更新即停止，日常推荐",
            btnDeepScan: "强制从 Gemini 页拉取",
            btnDeepScanTip: "让 Gemini 页面自动滚动侧边栏到底，抓取最完整历史",
            btnResync: "重扫页面",
            btnClearAll: "清空缓存",
        ...
        en: {
            ...
            btnIncrementalScan: "Sync (Incremental)",
            btnIncrementalScanTip: "Fast incremental sync, stops after 20 unchanged items (recommended)",
            btnDeepScan: "Deep Scan Gemini Page",
            btnDeepScanTip: "Automatically scrolls the Gemini sidebar to load full conversation history",
            btnResync: "Resync Page",
