...
def test_module_exports():
    files = {
        ...
        "src/ui/state/conversationsStore.js": ["getConversations", "setConversations", "getExportedIds", "loadStore", "getLastSync", "clearExported", "clearAll", "removeConversation", "reconcileWithCloud", "normalizeAndDeduplicate"],
