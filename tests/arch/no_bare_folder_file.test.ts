...
const ALLOWLIST: Record<string, string> = {
    ...
    'src/core/storage/storageService.ts:216': 'withConversationLock 内（_setConversationsRaw）',
    'src/core/storage/storageService.ts:290': 'withConversationLock 内（removeConversation）',
    'src/core/storage/storageService.ts:335': 'withConversationLock 内（reconcileConversations）',
    'src/core/storage/storageService.ts:379': '锁内（setExportedIds）',
    'src/core/storage/storageService.ts:462': 'enqueueSaveRecordChain 内（saveExportRecordsBatch）',
    'src/core/storage/storageService.ts:524': 'enqueueSaveRecordChain 内（removeExportRecords）',
    'src/core/storage/storageService.ts:547': 'withConversationLock 内（setLastSync）',
    'src/core/storage/storageService.ts:567': 'withConversationLock 内（setScanCheckpoint）',
    'src/core/storage/storageService.ts:578': 'withSlotLock 内（setAccountSlots）',
    'src/core/storage/storageService.ts:654': '单键盲写（setDevMode），无 read-modify-write',
    'src/core/storage/storageService.ts:670': '单键盲写（setTourCompleted），无 read-modify-write',
    'src/core/storage/storageService.ts:696': '单键盲写（setLastSeenFeatureVersion），无 read-modify-write',
    'src/core/storage/storageService.ts:713': '单键盲写（setTakeoutPromptCompleted），无 read-modify-write',
    'src/core/storage/storageService.ts:720': '单键盲写（setHasImportedTakeout），无 read-modify-write',
    // --- sessionStore.ts ---
