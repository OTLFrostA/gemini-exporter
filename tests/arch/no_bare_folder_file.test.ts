...
const ALLOWLIST: Record<string, string> = {
    ...
    'src/core/storage/storageService.ts:532': 'enqueueSaveRecordChain 内（removeExportRecords）',
    'src/core/storage/storageService.ts:555': 'withConversationLock 内（setLastSync）',
    'src/core/storage/storageService.ts:575': 'withConversationLock 内（setScanCheckpoint）',
    'src/core/storage/storageService.ts:586': 'withSlotLock 内（setAccountSlots）',
    'src/core/storage/storageService.ts:662': '单键盲写（setDevMode），无 read-modify-write',
    'src/core/storage/storageService.ts:678': '单键盲写（setTourCompleted），无 read-modify-write',
    'src/core/storage/storageService.ts:704': '单键盲写（setLastSeenFeatureVersion），无 read-modify-write',
    'src/core/storage/storageService.ts:721': '单键盲写（setTakeoutPromptCompleted），无 read-modify-write',
    'src/core/storage/storageService.ts:728': '单键盲写（setHasImportedTakeout），无 read-modify-write',
    // --- sessionStore.ts ---
