...
const __zhFactory = (): LocaleDictionary => {
    return {
            ...
            btnPdf: "导出 PDF",
            pdfBusy: "正在打开打印页，请稍候…",
            pdfOpened: "已在新标签页打开打印页，请在其中完成打印",
            pdfOpenFailed: "打开打印页失败: {0}",
            printTitle: "打印对话",
            printNotice1: "页码功能需要 Chrome 131 及以上版本；版本过低请升级浏览器。",
            printNotice2: "请在打印对话框中关闭浏览器自带的“页眉和页脚”，否则会与自定义页码叠加。",
            printNotice3: "单个元素高度超过一页时必然断裂；长表格在行边界分页是预期行为。",
            printLoading: "正在加载对话…",
            printNoConvId: "缺少对话 ID",
            printLoadFailed: "加载失败: {0}",
            printRetry: "重试",
            printEmpty: "该对话暂无可打印的消息",
            printRendering: "正在排版 {0}/{1}…",
            printReady: "排版完成，正在打开打印对话框…",
            printManual: "打印 / 另存为 PDF",
            printManualHint: "自动打印没有弹出？请点击按钮手动打印",
            printDialogClosed: "打印对话框已关闭",
            printImageFailed: "图片加载失败",
            printRoleUser: "你",
            printRoleAssistant: "Gemini",
            printRoleThinking: "思考过程",
            printTooLong: "该对话有 {0} 条消息，超过 1000 条，打印可能较慢，是否继续？",
