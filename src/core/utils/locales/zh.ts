...
const __zhFactory = (): LocaleDictionary => {
    return {
            ...
            btnCopyMarkdownTip: "复制 Markdown",
            btnExportCurrent: "📥 导出当前页面",
            btnOpenWorkbench: "去控制台批量导出 ↗",
            historyTotalSynced: "历史已同步:",
            popupNotGeminiDesc: "当前标签不是 gemini.google.com。在 Gemini 页面打开即可导出当前对话。",
            ...
            fmtJsonStandardTab: "JSON (标准)",
            fmtJsonRawTab: "JSON (原始)",
            fmtMarkdown: "Markdown (.md)",
            fmtHtml: "HTML 独立网页 (.html)",
            fmtPdf: "PDF (.pdf)",
            ...
            filterFailed: "导出失败",
            filterUnexportedOrFailed: "未导出 + 失败",
            filterSelectTip: "按导出状态筛选会话",
            titleConversations: "会话列表",
            ...
            logEmptyChatExported: "[{0}] 会话内容为空，已导出占位文件并归档",
            ...
            popupPdfUseOptions: "PDF 导出请前往选项页（批量导出）；此处快捷导出仅支持 Markdown/HTML/JSON。",
            ...
            startExport: "准备开始导出...",
            exportStartingDetail: "开始导出: {0} 个会话 | 格式: {1} | 目标: {2} | 包含资源: {3}",
            folder: "文件夹",
            ...
            takeoutParsingStructure: "正在解析 Takeout 归档目录结构...",
