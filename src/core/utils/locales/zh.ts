...
const __zhFactory = (): LocaleDictionary => {
    return {
            ...
            tourStep3Title: "步骤 3/5: 勾选要导出的对话",
            tourStep3Desc: "在列表中勾选要导出的对话，支持单选、多选或点击【全选】。",
            tourStep4Title: "步骤 4/5: 一键导出",
            tourStep4Desc: "默认导出为 Markdown 并打包为 ZIP（含图片附件）。点击按钮即可开始导出。",
            tourStep5Title: "步骤 5/5: 欢迎反馈",
            tourStep5Desc: "插件持续更新中。如遇问题或有建议，随时点击【反馈】告诉我们！",
            tourBtnNext: "下一步",
            tourBtnPrev: "上一步",
            tourBtnDone: "🎉 开始使用",
            tourBtnSkip: "跳过教程",
