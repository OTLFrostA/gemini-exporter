...
const __enFactory = (): LocaleDictionary => {
    return {
            ...
            liveSaveUpdateIndex: "Auto-maintain index README.md",
            ...
            tourStep4Title: "Step 4/5: Export",
            tourStep4Desc: "Exports to Markdown bundled in a ZIP (with images). Click the button to start.",
            tourStep5Title: "Step 5/5: Feedback & Support",
            tourStep5Desc: "We're constantly improving. If you encounter issues or have ideas, click 'Feedback' anytime!",
            tourBtnNext: "Next",
            tourBtnPrev: "Back",
