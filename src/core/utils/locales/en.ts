...
const __enFactory = (): LocaleDictionary => {
    return {
            ...
            btnPdf: "Export PDF",
            pdfBusy: "Opening print page, please wait…",
            pdfOpened: "Print page opened in a new tab — finish printing there.",
            pdfOpenFailed: "Failed to open print page: {0}",
            printTitle: "Print conversation",
            printNotice1: "Page numbers require Chrome 131+. Please upgrade if yours is older.",
            printNotice2: "Turn off the browser's own \"Headers and footers\" in the print dialog, or it will overlap the custom page numbers.",
            printNotice3: "An element taller than one page will inevitably break; long tables paginating at row boundaries is expected.",
            printLoading: "Loading conversation…",
            printNoConvId: "Missing conversation ID",
            printLoadFailed: "Failed to load: {0}",
            printRetry: "Retry",
            printEmpty: "This conversation has no printable messages.",
            printRendering: "Rendering {0}/{1}…",
            printReady: "Ready — opening print dialog…",
            printManual: "Print / Save as PDF",
            printManualHint: "Print dialog didn't appear? Click the button to print manually.",
            printDialogClosed: "Print dialog closed.",
            printImageFailed: "Image failed to load",
            printRoleUser: "You",
            printRoleAssistant: "Gemini",
            printRoleThinking: "Thinking",
            printTooLong: "This conversation has {0} messages (over 1000); printing may be slow. Continue?",
