// src/content/syncEngine.js - In-page active conversation detection & cloud batch sync
(function(root, factory) {
    ...
    const Scraper = (typeof DomScraper !== 'undefined') ? DomScraper : ((typeof window !== 'undefined' && window.DomScraper) || null);
    const Badge = (typeof BadgeView !== 'undefined') ? BadgeView : ((typeof window !== 'undefined' && window.BadgeView) || null);
    const Utils = (typeof GeminiUtils !== 'undefined') ? GeminiUtils : ((typeof window !== 'undefined' && window.GeminiUtils) || {});
    ...
    async function refreshInitialBadge() {
        try {
            ...
            if (typeof console !== 'undefined' && console.debug) console.debug('[GemExporter:syncEngine] refreshInitialBadge error', e);
        }
    }
        ...
        __storageWriteQueue = __storageWriteQueue.then(async () => {
            try {
                ...
                try {
                    ...
                    if (typeof console !== 'undefined' && console.debug) console.debug('[GemExporter:syncEngine]', e);
                }
    ...
    async function tryBatchExecuteFull(forceOpts) {
        if (typeof window !== 'undefined' && window.__gemExporterDeepScanPromise) return null;
        ...
        try {
            ...
            if (all && all.conversations && all.conversations.length) {
                ...
                const isFullExhaustive = !useIncremental && !all.stoppedEarly && !(typeof window !== 'undefined' && window.__gemExporterAborted);
